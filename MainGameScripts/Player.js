...
class Player {
    constructor(tileX, tileY) {
        ...
        this.speed = 3.3; //velocidade de movimento
        ...
        this.runSpeed = 6.4; //velocidade ao correr
...
function updatecamara(player) {
    ...
    const mapCamera = document.getElementById("map_camera"); //elemento da camara do mapa
    ...
    mapCamera.style.transform = `translateX(${-camaraX * scale}px)`; //mover o mapa para criar o efeito de camara
}

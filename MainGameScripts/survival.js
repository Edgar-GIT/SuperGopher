...
function GambleCoinPickup() { //decidir se a moeda da poder ou nao
    ...
    if (nextPowerUpGuaranteed) { //poder garantido
    ...
    return null; //nao devolve um poder
}
        ...
        case 'BOLT': //relampago aumenta velocidade e altura do salto
            ...
            if (boltActive) {
                ...
                if (now - lastBoltAlertTime > 2000) { //mostrar alert apenas se passaram 2 segundos
                    if (typeof MostrarAvisoTemporario === "function") {
                        MostrarAvisoTemporario("Espera antes de apanhar outro speedboost");
                    }
